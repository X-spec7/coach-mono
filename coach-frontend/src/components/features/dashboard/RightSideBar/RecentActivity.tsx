...
import { HeartBeatSvg, ClockSvg, FireSvg } from '@/components/shared/Svg'
            ...
            >
              <div className='flex flex-col items-center justify-start w-9 h-full gap-1.5'>
                <div className='flex justify-center items-center w-9 h-9 bg-blue rounded-full'>
                  <HeartBeatSvg width='18' height='18' />
                </div>
                {
              ...
              <div className='flex flex-1'>
                <Accordion open={open === (index + 1)} className='p-0 border-0'>
                  <AccordionHeader onClick={() => handleOpen(index + 1)} className='p-0 border-0'>
