...
from .views import LoginView, RegisterView, GetUserView, MailVerifyView, ForgetPasswordView, ResetPasswordView, UpdateProfileView, loginWithGoogle, GetUserInfo
